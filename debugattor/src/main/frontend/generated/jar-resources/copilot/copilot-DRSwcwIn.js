...
const mn = async (e, t, n) => window.Vaadin.copilot.comm(e, t, n), Ve = "copilot-", sl = "24.9.9", ll = "undefined", $u = "attention-required", Du = "https://plugins.jetbrains.com/plugin/23758-vaadin", ku = "https://marketplace.visualstudio.com/items?itemName=vaadin.vaadin-vscode", Tu = "https://marketplace.eclipse.org/content/vaadin-tools";
function Iu(e) {
...
function cc() {
  Ae.push(import("./copilot-log-plugin-ByIyigUA.js")), Ae.push(import("./copilot-info-plugin-DVJ2MfIy.js")), Ae.push(import("./copilot-features-plugin-CtafseTE.js")), Ae.push(import("./copilot-feedback-plugin-DLGTnIZk.js")), Ae.push(import("./copilot-shortcuts-plugin-BAip87XF.js"));
}
function uc() {
  {
...
let vi = class extends lc {
  ...
  async init() {
    if (this.initialized)
      return;
    await window.Vaadin.copilot._machineState.initializer.promise, await import("./copilot-global-vars-later-DJ33_iVQ.js"), await import("./copilot-init-step2-G7o1-tCw.js"), ml(), cc(), this.tabIndex = 0, Vt.hostConnectedCallback(), window.addEventListener("keydown", Kn), this.addEventListener("keydown", pi), y.onSend(this.handleSendEvent), this.removers.push(y.on("close-drawers", this.closeDrawers.bind(this))), this.removers.push(
