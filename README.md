...
Experiment execution tracker for ML/AI/Computer Vision projects. Start an execution, record its steps, and log artifacts (logs, images, JSON) for each step. At the end you get a complete, queryable history of the experiment.
